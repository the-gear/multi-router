...
First of all, thanks for your interest in contributing to the multi-router! 🎉
...
By contributing your code to the multi-router GitHub Repository, you agree to license your contribution under the MIT license.
